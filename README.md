...
기본 3패널과 측면 전신을 추가한 4패널, 두 가지 레이아웃을 지원합니다. Nano Banana Pro, FLUX, Midjourney 등에서 사용할 수 있도록 외형, 얼굴, 머리카락, 의상, 재질, 색상, 신발, 소품과 비대칭 디테일까지 구조적으로 정리합니다.
...
| 두 버전을 모두 요청 | 3패널 프롬프트와 4패널 프롬프트를 순서대로 제공 |
