# Three-Panel Character Sheet Specification
...
2. A two- or three-sentence Korean summary covering the character's key identity and outfit details and the left-panel face-exclusion rule.
...
Specify one clean professional character reference sheet divided into three tall vertical panels arranged left-to-right in a single row:

1. Left: front outfit and body view, face excluded.
2. Middle: complete full-body back view.
3. Right: close-up face portrait.

### Left Panel: Front Outfit and Body View, Face Excluded
...
### Middle Panel: Complete Back View
...
Require a straight neutral back-facing pose. Show the rear hairstyle, head shape, collar, shoulder construction, garment layers, seams, closures, rear pockets, straps, belts, holsters, bags, accessories, legs, heels, and soles. Match the left panel's character, scale, body proportions, clothing, materials, colors, and equipment.

### Right Panel: Close-Up Face Portrait
...
- **Hair:** style, length, color, roots, highlights, part, bangs, volume, texture, waves, curls, braids, tied or shaved sections, hairline, loose strands, and flyaways. Apply hair only to the middle and right panels.
- **Face:** structure, forehead, eyebrows, eyes, eyelids, lashes, nose, cheekbones, jaw, chin, lips, ears, skin texture, makeup, marks, scars, tattoos, paint, and piercings.
...
- **Footwear:** type, height, toe and heel design, sole thickness and color, fastening, panels, stitching, material, finish, wear, and exact color placement. Both shoes must be complete in the left and middle panels.
...
> Neutral light grey studio background in all three panels.

> Soft studio product photography lighting, subtle grounded contact shadows under feet.

Keep light direction, softness, exposure, white balance, color temperature, material response, and shadow density consistent. Use a seamless uncluttered studio background, accurate anatomy, clear silhouettes, neutral reference poses, crisp garment construction, balanced spacing, consistent body-view scale, and production-quality detail.
...
Then reinforce that all three panels show the exact same character at the same age with identical apparent identity, build, proportions, skin tone, hairstyle, hair color, face, outfit layers, garment construction, materials, textures, colors, footwear, props, weapons, accessories, lighting, and render style.

Clarify that the left panel represents the same character even though the head is outside the frame. The exclusion is a framing choice only and must not change the neck, shoulders, body proportions, clothing, or identity.
...
- any face, head, chin, ear, or hair entering the left panel;
- blank or featureless heads, mannequins, masks, blurs, shadows, blacked-out faces, floating features, or a decapitation effect;
- cropped shoulders, hands, fingers, legs, shoes, feet, the middle-panel head, or the middle-panel shoes;
...
- dynamic poses, perspective or wide-angle distortion, duplicate characters within a panel, dramatic backgrounds, text, labels, captions, decorative borders, and watermarks.
